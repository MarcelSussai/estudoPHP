...
// If
  ...
  // |─────────────────────────────────────────────────────────────────────────────────────────────|
  /*    Realizando o if
   *    se a resposta da idade for menor ou igual a idade da criança exiba "Criança" 
   */
    if ($idadeR <= $idadeC) {
        echo "Criança";
    }
  // |─────────────────────────────────────────────────────────────────────────────────────────────|
  /*    Senão se idade for maior que cirança e menor que adulto Então exiba "Adolescente"
   */
    else if ($idadeR > $idadeC && $idadeR < $idadeA) {
        echo "Adolescente";
    }
  // |─────────────────────────────────────────────────────────────────────────────────────────────|
  /*    Senão se idade for maior ou igual a adulto e menor que idoso exiba Adulto
   */
   ...
   */
    ...
    echo $pl;
  // |─────────────────────────────────────────────────────────────────────────────────────────────|
  /*    comparando com o if shortcut ou seja, uma maneira curta de validar coisas simples como 
   *    a escrita de um texto chamado de operador ternário
   *    Exemplo:
   */
...
// Switch Case
  ...
  // Criando a variável
    $diaSemana = date("w");
  // |─────────────────────────────────────────────────────────────────────────────────────────────|
  /*    caso seja o especificado executa o comando antes do break existe função nativa php
   *     para tratar datas, mas é apenas para fins didáticos:
   */
    switch ($diaSemana) {
        case 0:
            echo "domingo";
